                            ...
                            @foreach($order->orderDetails as $detail)
                                <tr>
                                    ...
                                    <td class="product-name">
                                        <span class="amount">{{ $detail->article->name }}</span>
                                    </td>
                                    
                                    <td class="product-price">
                                        <span class="amount">{{ $detail->article->price }}</span>
                                    </td>
                                    ...
                                    <td class="product-subtotal">
                                        <span class="amount">{{ number_format($detail->article->price * $detail->quantity, 2) }}</span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <div class="sticky-sidebar">
                        <div class="cart-summary mb-4">
                            ...
                            <ul class="shipping-methods mb-3">
                                <li>
                                    <label class="shipping-title text-dark font-weight-bold">Mode de reception</label>
                                </li>
                            </ul>
