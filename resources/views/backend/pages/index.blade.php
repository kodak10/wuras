...
<div class="page-titles mb-5">
  <div class="row">
    <div class="col-lg-8 col-md-6 col-12 align-self-center">
      ...
      <h2 class="mb-0 fw-bolderer fs-8">Gestionnaire Central</h2>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <ul class="nav nav-pills justify-content-end mt-md-n5" role="tablist">
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="index2.html#navpill-11" role="tab">
              <span>Pending</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" data-bs-toggle="tab" href="index2.html#navpill-22" role="tab">
              <span>Active</span>
            </a>
          </li>
        </ul>
              ...
              <table class="table mb-0 align-middle text-nowrap fs-3">
                <tbody>
                  <tr>
                    <td class="px-0">
                      <div class="d-flex align-items-center">
                        <img src="assets/backend/images/products/product-2.jpg" class="rounded" alt="product" />
                        <div class="ms-4">
                          <h5 class="mb-0 fs-4">
                  ...
                  <tr>
                    <td class="px-0">
                      <div class="d-flex align-items-center">
                        <img src="assets/backend/images/products/product-3.jpg" class="rounded" alt="product" />
                        <div class="ms-4">
                          <h5 class="mb-0 fs-4">
                  ...
                  <tr>
                    <td class="px-0">
                      <div class="d-flex align-items-center">
                        <img src="assets/backend/images/products/product-1.jpg" class="rounded" alt="product" />
                        <div class="ms-4">
                          <h5 class="mb-0 fs-4">
                  ...
                  <tr>
                    <td class="px-0 pb-0">
                      <div class="d-flex align-items-center">
                        <img src="assets/backend/images/products/product-4.jpg" class="rounded" alt="product" />
                        <div class="ms-4">
                          <h5 class="mb-0 fs-4">
          ...
          <div class="mt-4 pb-4 border-bottom">
            ...
            <div class="mt-2 pt-1 mb-2">
              <a href="javascript:void(0)" class="me-1">
                <img src="assets/backend/images/profile/user-3.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="John" class="rounded-circle" width="35" />
              </a>
              <a href="javascript:void(0)" class="me-1">
                <img src="assets/backend/images/profile/user-5.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Nirav" class="rounded-circle" width="35" />
              </a>
              <a href="javascript:void(0)" class="me-1">
                <img src="assets/backend/images/profile/user-6.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Sunil" class="rounded-circle" width="35" />
              </a>
              <a href="javascript:void(0)">
                <img src="assets/backend/images/profile/user-7.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Maruti" class="rounded-circle" width="35" />
              </a>
            </div>
          </div>
  ...
  <div class="col-lg-4">
    <div class="card">
      <div class="card-body">
        ...
        <div class="mt-4 pt-2">
          <img src="assets/backend/images/blog/blog-img2.jpg" class="blog-img rounded w-100" height="180" alt="flexy" />
